...
class Encryption:
    ...
    async def decode_base32(self, ctx, *, txtinput: str):
        """ Decode in base32 """
        try:
            await self.encryptout(ctx, "base32 -> Text", base64.b32decode(txtinput.encode('UTF-8')))
    ...
    async def decode_base64(self, ctx, *, txtinput: str):
        """ Decode in base64 """
        try:
            await self.encryptout(ctx, "base64 -> Text", base64.urlsafe_b64decode(txtinput.encode('UTF-8')))
        except Exception as e:
    ...
    async def encode_rot13(self, ctx, *, txtinput: commands.clean_content):
        """ Encode in rot13 """
        await self.encryptout(
            ctx, "Text -> rot13", codecs.decode(txtinput, 'rot_13')
        )
    ...
    async def decode_rot13(self, ctx, *, txtinput: str):
        """ Decode in rot13 """
        try:
            await self.encryptout(ctx, "rot13 -> Text", codecs.decode(txtinput, 'rot_13'))
        except Exception as e:
    ...
    async def encode_hex(self, ctx, *, txtinput: commands.clean_content):
        ...
        await self.encryptout(
            ctx, "Text -> hex",
            binascii.hexlify(txtinput.encode('UTF-8'))
        )
    ...
    async def decode_hex(self, ctx, *, txtinput: str):
        """ Decode in hex """
        try:
            await self.encryptout(ctx, "hex -> Text", binascii.unhexlify(txtinput.encode('UTF-8')))
        except Exception as e:
    ...
    async def encode_base85(self, ctx, *, txtinput: commands.clean_content):
        ...
        await self.encryptout(
            ctx, "Text -> base85",
            base64.b85encode(txtinput.encode('UTF-8'))
        )
    ...
    async def decode_base85(self, ctx, *, txtinput: str):
        """ Decode in base85 """
        try:
            await self.encryptout(ctx, "base85 -> Text", base64.b85decode(txtinput.encode('UTF-8')))
        except Exception as e:
    ...
    async def encode_ascii85(self, ctx, *, txtinput: commands.clean_content):
        ...
        await self.encryptout(
            ctx, "Text -> ASCII85",
            base64.a85encode(txtinput.encode('UTF-8'))
        )
    ...
    async def decode_ascii85(self, ctx, *, txtinput: str):
        """ Decode in ASCII85 """
        try:
            await self.encryptout(ctx, "ASCII85 -> Text", base64.a85decode(txtinput.encode('UTF-8')))
        except Exception as e:
